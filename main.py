...
if __name__ == "__main__":
    ...
    cloner = VoiceCloner(speaker_wav="./voice-samples/geralt_original.mp3")

    # Convert text to speech and play the audio
    transcripts = [
        "Hello everyone, and welcome to this presentation about SlideSpeech! SlideSpeech is a powerful Python script designed to automate your presentations. Whether you're using a PDF or PPTX file, SlideSpeech can play an audio file for each slide and automatically advance to the next slide once the audio finishes. This tool is perfect for anyone looking to deliver hands-free, professional presentations with ease. Let’s dive into its key features!",
    ...
    for i, transcript in enumerate(transcripts):
        cloner.say(transcript, language="en", play_audio=True, save_audio=True, speed=1.0)